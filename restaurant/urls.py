...
urlpatterns = [
    ...
    path("restaurant/menu/items", views.MenuItemViewAPI.as_view(), name="menu-items"),
    ...
    path("restaurant/menu/items/<int:pk>", views.SingleMenuItemViewAPI.as_view(), name="menu-item"),
]
